  ...
  protected
    def self.set_pagination_headers(name, options = {})
      after_filter(options) do |controller|
        ...
        unless results.nil?
          ...
          headers["X-Records-Offset"] = results.offset.to_s
          headers["X-Records-Limit"] = results.limit_value.to_s
    ...
    def set_cors_headers
      if request.headers["HTTP_ORIGIN"]
        ...
        headers["Access-Control-Expose-Headers"] = 'X-Next-Link,X-Previous-Link,X-Records-Offset,X-Records-Limit,X-Page,X-Total-Pages,X-Total-Records,ETag'
